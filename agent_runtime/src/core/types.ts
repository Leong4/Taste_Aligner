...
// ---------------------------------------------------------------------------
// caption_sentiment types
// ---------------------------------------------------------------------------

export type CaptionSentimentSource =
    | "caption_lexicon_v1"
    | "missing_caption"
    | "no_sentiment_signal";
...
export interface CaptionSentimentOutput {
    ...
    matched_terms: string[];
    decision_trace: { caption_sentiment: CaptionSentimentDecisionTrace };
}
...
export interface PersistMemoryOutput {
    ...
    error_code?: string;
    error_message?: string;
    decision_trace: { persist_memory: PersistMemoryDecisionTrace };
}
...
export interface MemoryWeightAdjustDecisionTrace extends Record<string, unknown> {
    ...
    query_embedding_fallback_reason?:
