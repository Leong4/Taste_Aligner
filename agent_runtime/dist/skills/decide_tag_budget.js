...
exports.decideTagBudgetSkill = void 0;
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
function buildReasons(tokenCount, hardSeedCount, softHintCount, softHintsDetected, intentType, tBonus, lBonus, budget) {
    const reasons = [];
...
exports.decideTagBudgetSkill = {
    ...
    async execute(input, _context) {
        ...
        const reasons = buildReasons(tokenCount, hardSeedCount, softHintCount, softHintsDetected, intentType, tBonus, lBonus, budget);
        const output = {
            budget,
...
//# sourceMappingURL=decide_tag_budget.js.map